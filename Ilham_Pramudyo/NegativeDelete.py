...
class testUpdateUser(unittest.TestCase):
    ...
    def test_TCU_1(self):
        ...
        time.sleep(2)
        driver.find_element(By.ID,"searching").send_keys("Delbert McCullough")
        time.sleep(1)
        driver.find_element(By.XPATH,"/html//form[@action='/Dashboard']/input[@value='Search']").click()
        driver.find_element(By.XPATH,"/html/body/div//table//a[@href='/Customer/Delete/3805']").click()
        time.sleep(2)
        driver.find_element(By.XPATH,"/html/body/div//form[@action='/Customer/Delete/3805']//a[@href='/Dashboard']").click()
        driver.find_element(By.ID,"searching").send_keys("Delbert McCullough")
        driver.find_element(By.XPATH,"/html//form[@action='/Dashboard']/input[@value='Search']").click()
        time.sleep(5)
